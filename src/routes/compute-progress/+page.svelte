...
<Col class="col-24 mb-4">
	<h1 class="text-light-content dark:text-dark-content mb-0">computeProgress</h1>
	<Divider />
</Col>
		...
		<Card.Content>
			<Row>
				<Col class="col-24 sm:col-8">
					<InputNumber label="Value" name="value" bind:value on:input={handleChange} class="pr-2" />
				</Col>
				<Col class="col-24 sm:col-8">
					<InputNumber
						label="Goal"
