<script lang="ts">
	import { Button, Card, Col, Notification, Divider } from '../../lib';
	import {
		example,
		typeExample,
		type2Example,
...
<Col class="col-24 mb-4">
	<h1 class="text-light-content dark:text-dark-content mb-0">Notification</h1>
	<Divider />
</Col>
		...
		<Notification>
			...
			<Notification.Extra slot="extra" class="-top-2 -right-2">
				<Button
					...
					trailing="arrow_forward">Details</Button
				>
			</Notification.Extra>
		</Notification>
