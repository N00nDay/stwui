<script lang="ts">
	...
	const defaultClass =
		'table min-w-full border-separate bg-light-surface dark:bg-dark-surface border-spacing-0 table-fixed border-b border-light-border-base dark:border-dark-border';
