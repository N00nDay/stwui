...
{:else if type === 'pill'}
	<label
		...
		class="group relative border border-light-icon-background dark:border-dark-icon-background rounded-md py-3 px-3 flex items-center justify-center text-sm font-medium sm:flex-1 cursor-pointer focus:outline-none transition-all duration-150"
